...
def main():
    ...
    screen = grab_screen(get_window_location('3D Car Simulator - Play 3D Car Simulator on CrazyGames'))
    screen = image_processing(screen)
